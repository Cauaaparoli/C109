...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		print("Tamanho da tela do computador: ", screen_width, screen_height)
		print("Tamanho da janela de resultado: ", width, height)
		print("Posição central da linha das pontas: ", center_x, center_y)
